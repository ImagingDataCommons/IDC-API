...
def get_query_next_page():
    query_info = query_next_page(request)
    return query_info
...
def perform_query(url, body, special_fields):
    next_page = ""
    try:
        data = {
            "request_data": body
